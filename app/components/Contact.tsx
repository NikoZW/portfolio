...
const Contact = () => {
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!accessKey) {
      console.error("Missing Web3Forms access key. Please set NEXT_PUBLIC_WEB3FORMS_ACCESS_KEY in .env.local")
  ...
  return (
    ...
    >
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        >
          Submit now <Image src={assets.right_arrow_white} alt='' className='w-4' width={16} height={16} />
        </button>
