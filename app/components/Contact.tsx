      ...
      <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-10 mb-8">
          <input
            ...
            required
            className="flex-1 p-3 outline-none border-[0.5px] border-gray-400 dark:border-gray-500 rounded-md bg-white dark:bg-gray-800 dark:text-gray-100"
          />
          <input
            type="email"
            name="email"
        ...
        <textarea
          ...
          required
          className="w-full p-4 outline-none border-[0.5px] border-gray-400 dark:border-gray-500 rounded-md bg-white dark:bg-gray-800 dark:text-gray-100 mb-6"
        ></textarea>
        <button
          type="submit"
          className="py-3 px-8 w-max flex items-center justify-between gap-2 bg-black dark:bg-gray-800/80 text-white rounded-full mx-auto hover:bg-gray-800 dark:hover:bg-gray-700/80 transition-colors duration-500"
        >
          Submit now{" "}
          <Image
